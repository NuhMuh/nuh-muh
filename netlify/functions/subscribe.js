...
function buildWelcomeHtml(unsubUrl) {
  ...
  return [
    ...
    p('이야기와 사람을 잇는 길.<br>우리는 그 길을 발견하고, 걷고 걸어 잘 닦아놓지요.'),
    p('여러 가지 판이 너머에서 열립니다.<br>다채로운 사람들이 모여 함께 또는 혼자 이야기를 만들고, 그것을 다른 사람들과 주고받지요.'),
    p("앞으로 'Nuh-Muh'가 당신에게 꾸준히 편지를 보낼 것입니다.<br>아는 얼굴이 또 생겨서 좋군요."),
    // 주소 + 밑줄 링크
...
export default async (req) => {
  ...
  const welcomeText = [
    ...
    '',
    '이야기와 사람을 잇는 길.',
    '우리는 그 길을 발견하고, 걷고 걸어 잘 닦아놓지요.',
    '',
    '여러 가지 판이 너머에서 열립니다.',
    '다채로운 사람들이 모여 함께 또는 혼자 이야기를 만들고, 그것을 다른 사람들과 주고받지요.',
    '',
    "앞으로 'Nuh-Muh'가 당신에게 꾸준히 편지를 보낼 것입니다.",
    '아는 얼굴이 또 생겨서 좋군요.',
    '',
